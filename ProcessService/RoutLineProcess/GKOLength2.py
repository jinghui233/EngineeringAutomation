...
class GKOLength:
    ...
    def calculate_inner_length(self, gko_img, l_img):
        ...
        # outer region
        dilate_img = cv2.dilate(labels, kernel=cv2.getStructuringElement(cv2.MORPH_ELLIPSE, ksize=(9, 9)))
        SaveImage(r"Debug\dilate_img.jpg", dilate_img)
        ...
        SaveImage(r"Debug\intersection_kl.jpg", intersection_kl)
        ...
        SaveImage(r"Debug\inner_region_img.jpg", inner_region_img)
