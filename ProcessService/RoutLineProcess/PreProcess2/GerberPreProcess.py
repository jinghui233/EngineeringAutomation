...
from ProcessService.RoutLineProcess.PreProcess2.LinePice import LinePice
from ProcessService.RoutLineProcess.PreProcess2.LineSet import LineSet
from ProcessService.RoutLineProcess.PreProcess2.SignType import SignType, SetCut
...
class GerberPreProcess:
    ...
    def __OverLapping_Pice(self, lineSet1: LineSet, lineSet2: LineSet):
        for line1index in range(lineSet1.linesNum):
            ...
            for line2index in range(lineSet2.linesNum):
                ...
                if line1.signType == SignType.Delete and line2.signType == SignType.Delete:
    ...
    #  处理交叉
    def __cross(self, line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint):
        # **********************************处理交叉************************************************
        if crossPoint != None and not (isl1spinl2 or isl1epinl2 or isl2spinl1 or isl2epinl1):
            iscpinl1, cpinl1 = AGFuncs.PointIsInLine(line1.gbLine, crossPoint)
            iscpinl2, cpinl2 = AGFuncs.PointIsInLine(line2.gbLine, crossPoint)
    ...
    #  处理相交
    def __intersect(self, line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint):
        # ***********************************处理相交***********************************************
        if isl1spinl2:
            if not (l1spinl2 == line2.start or l1spinl2 == line2.end):
                line2.signType = SignType.Cut
    ...
    #  处理删除
    def __delete(self, line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint):
        # ******************处理删除************************************
        if isl1spinl2 and isl1epinl2:
            line1.signType = SignType.Delete
        if isl2spinl1 and isl2epinl1:
    ...
    #  处理set切割
    def __setCut(self, line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint):
        # **************************处理集合分割**************************
        if isl1spinl2 or isl1epinl2:
            if l1spinl2 == line2.start or l1epinl2 == line2.start:
                line2.setCut = SetCut.Start
            if l1spinl2 == line2.end or l1epinl2 == line2.end:
                line2.setCut = SetCut.End
        if isl2spinl1 or isl2epinl1:
            if l2spinl1 == line1.start or l2epinl1 == line1.start:
                line1.setCut = SetCut.Start
            if l2spinl1 == line1.end or l2epinl1 == line1.end:
                line1.setCut = SetCut.End

    def __CutDelSplit_Set(self):
        for curSet in self.sets:
            SameSets = self.FindCoincide(curSet)
            for SameSet in SameSets:
                if SameSet.HasCompared:
    ...
    def __CutDelSplit_Pice(self, lineSet1: LineSet, lineSet2: LineSet):
        for line1index in range(lineSet1.linesNum):
            line1 = lineSet1.GetLine(line1index)
            for line2index in range(lineSet2.linesNum):
                line2 = lineSet2.GetLine(line2index)
                ...
                isl2epinl1, l2epinl1 = AGFuncs.PointIsInLine(line1.gbLine, line2.end)
                crossPoint = AGFuncs.get_line_cross_point(line1.gbLine, line2.gbLine)
                self.__cross(line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint)
                self.__intersect(line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint)
                self.__delete(line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint)
                self.__setCut(line1, line2, isl1spinl2, l1spinl2, isl1epinl2, l1epinl2, isl2spinl1, l2spinl1, isl2epinl1, l2epinl1, crossPoint)
            line1.HasCompared = True
...
#     image = imageGenerater.DrawShow(lineset.sets, True)
...
if __name__ == '__main__':
    ...
    for groupDir in groupDirs:
        ...
        for orderDir in orderDirs:
            ...
            # if index == 5:
            #     continue
            if not indexset.__contains__(index):
                continue
            gerbers = dataPrepar(f"{gerberFilePath}\{groupDir}\{orderDir}")
            imageGenerater = ImageGenerater(gerbers)
            lineset = GerberPreProcess(imageGenerater.gerberLayers["gko"])
            image = imageGenerater.DrawShow(lineset.sets, False)
            cv2.imshow("test", image)
            cv2.waitKey(-1)
